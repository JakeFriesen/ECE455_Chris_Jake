    ...
    while (1)
    {
        ...
        if (xQueueReceive(xDDSQueue_handle, &sch_msg, CURRENT_SLEEP))
        {
            ...
            case create:
                ...
                // TODO: complete here case delete : deleted = remove_node(&head, sch_msg.DATA->tid);
                // TODO: complete here if (deleted != NULL)
                {
                    // TODO: complete here
                }
            case return_active_list:
                // TODO: complete here case return_overdue_list : // TODO: complete here 
                default : printf("DDScheduler received an invalid msg!\n");
            }
        }
        else
        {
...
static void Task_Generator(void *pvParameters)
{
    ...
    pTaskParameters.execution_cycle = // TODO: complete here;
...
static TaskHandle_t dd_tcreate(auxTPARAM * auxtParameter, const char *const task_name)
{
    ...
    // TODO: complete here if (xTaskCreate(Auxiliary_Task, task_name, Aux_STACK_SIZE, auxtParameter, 1,
                                    &Aux_thandle) == pdPASS)
    {
        // TODO: complete here if (xQueueSend(xDDSQueue_handle, &Aux_tcmsg, 100))
        {
...
static BaseType_t dd_delete(TaskHandle_t TaskToDelet)
{
        ...
        // TODO: complete here if (xQueueSend(xDDSQueue_handle, &Aux_tcmsg, 100))
    {
        if (xQueueReceive(deleteQueue_handle, &response, 100))
        {
            if (response == pdPASS)
            {
                // TODO: complete here return pdPASS;
            }
            else
                return pdFAIL;
        }
    ...
    else
    {
        // TODO: complete here
            ...
            while (current->next != NULL){
                // TODO: complete here} temp_node = (node *)current->next;
